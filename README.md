...
[![Appveyor build status](https://ci.appveyor.com/project/CatalystAdmin/healthcareai-py/branch/master?svg=true)](https://ci.appveyor.com/project/CatalystAdmin/healthcareai-py)
