...
[![Appveyor build status](https://ci.appveyor.com/api/projects/status/github/HealthCatalyst/healthcareai-py?branch=master)](https://ci.appveyor.com/project/CatalystAdmin/healthcareai-py?svg=true)
